    ...
    <div className="v" position="absolute" white-space="normal" display="block">
      <VerticalTimeline>
        ...
        >
          <a
            className="proj"
            href="https://github.com/DineshSainath/React/tree/master/19.%20keeper-app-part-2"
            target="_blank"
          >
            <SiGithub size={30} />
          </a>
          <a
            className="proj"
            href="https://codesandbox.io/s/using-pre-built-react-components-forked-pjv54"
            target="_blank"
          >
            <SiCodesandbox size={30} />
          </a>
          <h3 className="vertical-timeline-element-title">Keeper</h3>
          <h5 className="vertical-timeline-element-subtitle">
            Web Application &ensp; <DiReact size={25} />{' '}
            <DiNodejsSmall size={25} /> <DiHtml5 size={25} />{' '}
            <DiCss3 size={25} />
          </h5>
        ...
        >
          <a
            className="proj"
            href="https://github.com/DineshSainath/ToDoList"
            target="_blank"
          >
            <SiGithub size={30} />
          </a>
          ...
          <h5 className="vertical-timeline-element-subtitle">
            Web Application &ensp; <DiNodejsSmall size={25} />{' '}
            <DiMongodb size={25} /> <DiHtml5 size={25} /> <DiCss3 size={25} />
          </h5>
          <p>
        ...
        >
          <a
            className="proj"
            href="https://github.com/DineshSainath/BlogSite"
            target="_blank"
          >
            <SiGithub size={30} />
          </a>
        ...
        >
          <a
            className="proj"
            href="https://github.com/DineshSainath/DrumKit"
            target="_blank"
          >
            <SiGithub size={30} />
          </a>
          ...
          <h5 className="vertical-timeline-element-subtitle">
            Javascript application &ensp; <SiJavascript size={25} />{' '}
            <DiHtml5 size={25} /> <DiCss3 size={25} />
          </h5>
        ...
        >
          <a
            className="proj"
            href="https://github.com/DineshSainath/Java-Estore"
            target="_blank"
          >
            <SiGithub size={30} />
          </a>
